...
$ py.test -v test_sorter.py 

Changed the / to \\ for the os returned path as supported by this version of python
"""
...
class RenamerTests(unittest.TestCase):
    ...
    def test_dest_path(self):
        case = sorter.dest_path('/Photos', 'test_examples/2004-05-07 20.16.31.jpg')
        expected  = '/Photos\\2004\\2004-05\\2004-05-07 20.16.31.jpg'
        self.assertEqual(case,expected)
    ...
    def test_move_file(self, move_mock, makedirs_mock):       
        sorter.move_file('/Temp', 'test_examples/2006-09-09 07.00.24.jpg')
        makedirs_mock.assert_called_with('/Temp\\2006\\2006-09')
        move_mock.assert_called_with(
            'test_examples/2006-09-09 07.00.24.jpg',
            '/Temp\\2006\\2006-09\\2006-09-09 07.00.24.jpg')
